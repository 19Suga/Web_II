...
$serverName = 'DESKTOP-8AKN9FQ';
$database = 'doguito';
$username = '';
$password = "";

try{
    $conn= new PDD("sqlsrv:Server=$serverName; DataBase=$database, $userName, $password");
    $conn->setAttribute(PDD::ATTR_ERRMODE, PDD::ERRMODE_EXCEPTION);
